...
extension TrackController: NSMenuDelegate {
    ...
    @IBAction func menuShowAuthor(_ sender: Any) {
        ...
        ViewController.shared.trackController.filterController.rules = PlaylistRules(labels: [TrackLabel.Author(author: track.rAuthor)])
    }
    ...
    @IBAction func menuShowAlbum(_ sender: Any) {
        ...
        ViewController.shared.trackController.openFindPanel()
        ViewController.shared.trackController.filterController.rules = PlaylistRules(labels: [TrackLabel.InAlbum(album: Album(of: track))])
    }
